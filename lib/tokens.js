...
export const SERVICES = [
  { cat: 'Business & Management', count: 6, href: '/services/business-consulting', items: [
  ...
  { cat: 'Digital & Creative', count: 4, href: '/services/app-development', items: [
  ...
  { cat: 'Legal & Documentation', count: 3, href: '/contact', items: [
  ...
  { cat: 'Expat & Government', count: 3, href: '/services/expat-visa', items: [
  ...
  { cat: 'Financial', count: 1, href: '/services/accounting-mira', items: [
