...
import { COMPARE_PAGES } from '../../../lib/pages-config';
...
export function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: { canonical: `https://mv.metamorphosis.com.bd/compare/${page.slug}` },
    openGraph: {
      title: page.title,
      description: page.description,
      url: `https://mv.metamorphosis.com.bd/compare/${page.slug}`,
    },
  };
}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLd(breadcrumbSchema([
            ...
            { name: page.h1, url: `/compare/${page.slug}` },
          ])),
        }}
      />
      {page.faqs && (
